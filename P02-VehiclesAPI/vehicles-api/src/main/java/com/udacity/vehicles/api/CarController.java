...
//    private WebClient webClientPricing = (WebClient) context.getBean("pricing",WebClient.class);
    ...
    ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        try {
            ...
            System.out.println("not found id car");
        }
        return ResponseEntity.ok("Not found id car");
    }
}
