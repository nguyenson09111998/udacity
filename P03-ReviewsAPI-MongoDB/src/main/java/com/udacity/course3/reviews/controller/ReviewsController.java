...
public class ReviewsController {
    ...
    @Autowired
    ReviewMGRepository reviewMGRepository;
    ...
    public ResponseEntity<?> createReviewForProduct(
        ...
        try {
            ...
            reviewMG.setId(save.getId());
            reviewMG.setContent(review.getContent());
            reviewMG.setProductId(review.getProduct().getId());
            reviewMGRepository.insert(reviewMG);
...
//            List<Review> list = reviewRepository.findAllByProductId(productId);
            List<ReviewMG> list = reviewMGRepository.findReviewByProductId(productId);
